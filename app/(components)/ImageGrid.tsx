    ...
    <>
      ...
      <footer className="image-grid-pagination mt-auto flex flex-col sm:flex-row items-center justify-end gap-[0.75rem] p-[1.5rem]">
        ...
        <div className="flex items-center gap-[0.75rem]">
          <button
            disabled={page == 1}
            className={`btn p-[0.5rem] bg-white border border-slate-400 rounded-lg flex items-center justify-center cursor-pointer ${page == 1 ? "cursor-not-allowed! opacity-[0.5]" : ""}`}
            onClick={() => setPage(1)}
          >
          ...
          <button
            ...
            className={`btn p-[0.5rem] bg-white border border-slate-400 rounded-lg flex items-center justify-center cursor-pointer ${page >= totalPages ? "cursor-not-allowed! opacity-[0.5]" : ""}`}
            onClick={() => setPage((prev) => prev + 1)}
          >
            <span className="icon-container w-[2rem] h-[2rem] flex items-center justify-center">
              <svg
